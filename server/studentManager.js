...
var searchByMark = function(mark){
    var listofstudents;
    
    if(mark ==){
        listofstudents = searchMaggiore();
    }
    else{
        listofstudents = searchMinore();
...
var searchMaggiore = function(){
    var i ;
    var listofstudents = new Array();
    for(i=0;listofstudents.length;i++){
        if(listofstudents[i].mark > 7){
            listofstudents.push(listofstudents[i]);
        }
    }
    return listofstudents;
}

var searchMinore = function(listofstudents){
    var listofstudents = new Array();
    var i ;
    for(i=0;listofstudents.length;i++){
        if(listofstudents[i].mark < 7){
